...
data:extend({
		...
		variants =
    {
      ...
      {
        {
          picture = "__Henrikshell__/graphics/terrain/dirt/dirt1.png",
          count = 22,
          size = 1,
        ...
        {
          picture = "__Henrikshell__/graphics/terrain/dirt/dirt2.png",
          count = 30,
          size = 2,
          probability = 1,
        ...
        {
          picture = "__Henrikshell__/graphics/terrain/dirt/dirt4.png",
          count = 21,
          line_length = 11,
          size = 4,
          probability = 1,
      ...
      inner_corner =
      {
        picture = "__Henrikshell__/graphics/terrain/dirt/dirt-inner-corner.png",
        count = 8
      },
      outer_corner =
      {
        picture = "__Henrikshell__/graphics/terrain/dirt/dirt-outer-corner.png",
        count = 8
      },
      side =
      {
        picture = "__Henrikshell__/graphics/terrain/dirt/dirt-side.png",
        count = 8
      }
    },
    walking_sound =
