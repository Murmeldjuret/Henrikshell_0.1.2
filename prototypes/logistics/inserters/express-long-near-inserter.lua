    data:extend(
{
  {
    type = "item",
    name = "express-long-near-inserter",
    icon = "__Henrikshell__/graphics/icons/inserters/express-long-near-inserter.png",
    flags = {"goes-to-quickbar"},
    subgroup = "inserters",
    order = "f[inserter]-f[express-inserter-2-1]",
    place_result = "express-long-near-inserter",
    stack_size = 50
  },
   {
    type = "recipe",
    ...
    result = "express-long-near-inserter"
  },
  {
    type = "inserter",
    name = "express-long-near-inserter",
    ...
    minable = {hardness = 0.2, mining_time = 0.5, result = "express-long-near-inserter"},
    max_health = 40,
