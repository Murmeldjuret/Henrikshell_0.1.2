data:extend(
{
  {
    type = "item",
    name = "express-near-inserter",
    icon = "__Henrikshell__/graphics/icons/inserters/express-near-inserter.png",
    flags = {"goes-to-quickbar"},
    subgroup = "inserters",
    order = "f[inserter]-f[express-inserter-1-1]",
    place_result = "express-near-inserter",
    stack_size = 50
  },
   {
    type = "recipe",
  ...
  },
  {
    ...
    minable = {hardness = 0.2, mining_time = 0.5, result = "express-near-inserter"},
    max_health = 40,
...
--    uses_arm_movement = "basic-inserter",
    ...
    hand_base_picture =
    {
      filename = "__Henrikshell__/graphics/entity/inserters/cyan-inserter-hand-base.png",
      priority = "extra-high",
      width = 8,
      height = 34
    },
