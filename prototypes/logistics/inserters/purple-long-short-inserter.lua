...
{
  {
    ...
    icon = "__Henrikshell__/graphics/inserters/purple-long-short-inserter.png",
...
--    uses_arm_movement = "basic-inserter",
    ...
    hand_closed_picture =
    {
      filename = "__Henrikshell__/graphics/inserters/purple-inserter-hand-closed.png",
      priority = "extra-high",
      width = 18,
      height = 41
    },
    hand_open_picture =
    {
      filename = "__Henrikshell__/graphics/inserters/purple-inserter-hand-open.png",
      priority = "extra-high",
      width = 18,
      height = 41
    },
