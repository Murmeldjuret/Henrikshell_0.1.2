...
{
{
    ...
    name = "house-1",
    order = "a-1",
    ingredients = {{"stone", 10},{"raw-wood",5}},
    result = "house-1"
  },
  {
    type = "recipe",
    name = "house-2",
    order = "a-2",
    ingredients = {{"stone-brick", 20},{"iron-plate",5}},
    result = "house-2"
  },
  {
    type = "recipe",
    name = "house-3",
    order = "a-3",
    ingredients = {{"cement", 5},{"stone-brick",40},{"steel-plate",5}},
    result = "house-3"
  },
  {
    type = "recipe",
    name = "house-4",
    order = "a-4",
    ingredients = {{"concrete", 80},{"steel-plate",10}},
    result = "house-4"
  },
  }
  )